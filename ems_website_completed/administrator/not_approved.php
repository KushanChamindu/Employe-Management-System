...
$output = '';
$sql = "SELECT * FROM leave_table WHERE status=1 ORDER BY date_of_request DESC";
$statusList=array("Not Applied","Pending","Canceled","Approved","Declined");

$result = mysqli_query($db,$sql);
if(mysqli_num_rows($result) > 0){
    $output .= '<h4 align ="center" style="font-size:32px; font-weight: bold;">New Leave Request</h4>';
    $output .= '<br><br>';
