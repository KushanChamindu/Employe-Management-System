    ...
    while($row =mysqli_fetch_array($result))
    {
        $output .= '
            <tr class="clickableRaw">
                ...
                <td>
                <a href="editProfileForm.php?no='.$row['Num_Employee'].'"><span class="label label-warning">Edit</span></a>
                &nbsp;
                <a href="viewProfileForm.php?no='.$row['Num_Employee'].'"><span class="label label-info">Profile</span></a>
                &nbsp;
                <a href="employee_manage.php?no='.$row['Num_Employee'].'=2=0" onclick="return confirm(/      Are You Sure ?      /)"><span class="label label-danger">Delete</span></a></td>
            </tr>
        ';
    }
    echo $output;
